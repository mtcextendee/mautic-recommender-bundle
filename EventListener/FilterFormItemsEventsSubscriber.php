...
class FilterFormItemsEventsSubscriber extends CommonSubscriber
{
    ...
    {
        $event->addChoice('item_events_filter', 'mautic.plugin.recommender.form.type.recommend_items_to_items_events', 'items_events');
